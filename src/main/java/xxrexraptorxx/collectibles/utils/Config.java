...
public class Config {
    ...
    static {
        ...
        EPIC_LOOT_BAG_REWARDS = SERVER_BUILDER.comment("Epic loot bag rewards [amount*modid:item]").defineListAllowEmpty("epic_loot_bag_rewards",
                Arrays.asList(
        ...
        LOOT_BAG_REWARDS = SERVER_BUILDER.comment("Loot bag rewards [amount*modid:item]").defineListAllowEmpty("loot_bag_rewards",
                Arrays.asList(
