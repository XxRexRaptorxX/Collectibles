...
public class LootModifierProvider extends GlobalLootModifierProvider {
    ...
    private static final ResourceLocation DESERT_WELL =
            ResourceLocation.withDefaultNamespace("archaeology/desert_well");
    private static final ResourceLocation OCEAN_RUIN_WARM =
            ResourceLocation.withDefaultNamespace("archaeology/ocean_ruin_warm");
    private static final ResourceLocation OCEAN_RUIN_COLD =
    ...
    private static final ResourceLocation STRONGHOLD =
    ...
    private static final ResourceLocation DESERT_TEMPLE =
    ...
    protected void start() {
        ...
        for (Item item : suspicious_blocks_loot) {
            ...
            add(
                    name + "_from_pyramid_suspicious_blocks",
                    new SuspiciousLootModifier(
            ...
            add(
                    name + "_from_well_suspicious_blocks",
                    new SuspiciousLootModifier(
                            new LootItemCondition[] {
            ...
            add(
                    name + "_from_cold_ocean_ruin_suspicious_blocks",
                    new SuspiciousLootModifier(
                            new LootItemCondition[] {
            ...
            add(
                    name + "_from_warm_ocean_ruin_suspicious_blocks",
                    new SuspiciousLootModifier(
                            new LootItemCondition[] {
            ...
            add(
                    name + "_from_trail_ruins_suspicious_blocks",
                    new SuspiciousLootModifier(
                            new LootItemCondition[] {
            ...
            add(
                    name + "_from_trail_ruins_c_suspicious_blocks",
                    new SuspiciousLootModifier(
                            new LootItemCondition[] {
        ...
        for (Item item : chest_loot) {
            ...
            add(
                    name + "_from_mineshaft",
                    new ChestLootModifier(
                            new LootItemCondition[] {
